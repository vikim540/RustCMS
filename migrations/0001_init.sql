...
INSERT OR IGNORE INTO ay_menu (id, mcode, pcode, name, url, ico, sorting, status, shortcut, type) VALUES
  ...
  (7,  'M205', 'M400','自定義表單(舊)','/admin/content/form',  '',   250, '0', '0', '1'),
...
INSERT OR IGNORE INTO ay_role (id, code, rcode, name, description, levels, status) VALUES
  (1, 'R101', 'R101', '超級管理員',     '最大管理權限',
   'M100,M600,M503,M207,M206,M610,M501,M502,M202,M200,M201,M208,M400,M203,M204,M205,M210,M401,M402,M403,M405,M300,M500,M504,M505,M506,M507,M301,M508', '1'),
  (2, 'R102', 'R102', '文案編輯',       '資料修改文案上傳',
   'M100,M200,M201,M208,M400,M203,M204,M210,M401,M402,M300,M205,M301', '1'),
  (3, 'R103', 'R103', 'EndoscopyAdmin', 'Endoscopy站點超級管理員',
   'M100,M600,M503,M207,M206,M610,M501,M502,M202,M200,M201,M208,M400,M203,M204,M205,M210,M401,M403,M405,M300,M301,M508,M402,M500,M504,M505,M506,M507', '1'),
...
INSERT OR IGNORE INTO ay_role_level (rcode, level) VALUES
  ...
  ('R101','M205'),('R101','M210'),('R101','M401'),('R101','M402'),('R101','M403'),('R101','M405'),
  ...
  ('R103','M205'),('R103','M210'),('R103','M401'),('R103','M403'),('R103','M405'),('R103','M300'),
