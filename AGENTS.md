...
> **強制約束文件**。所有代碼生成、修改、審查必須遵守。當前版本：**v1.9.8**（2026-07-22）
...
| 版本 | 日期 | 摘要 |
|------|------|------|
| v1.9.8 | 2026-07-22 | 修復 HTML 源碼模式切換後編輯器消失。原因：條件渲染導致 editorRef div 被卸載，Quill 實例指向已移除的 DOM。修復：編輯器 div 與 textarea 都保持掛載，改用 CSS hidden 切換顯示 |
